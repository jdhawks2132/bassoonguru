...
ActiveRecord::Schema.define(version: 2022_01_11_022551) do
  ...
  create_table "response_to_comments", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["comment_id"], name: "index_response_to_comments_on_comment_id"
    t.index ["response_id"], name: "index_response_to_comments_on_response_id"
  end
